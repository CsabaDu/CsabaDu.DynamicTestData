...
: ITestData
{
    ...
    protected readonly string definitionOrName = GetValueOrSubstitute(
        Definition,
        nameof(Definition));
    ...
    protected static string GetValueOrSubstitute(
        string? value,
        string substitute)
    ...
    ITestData<string, T1>
{
    ...
    => $"{definitionOrName} => {(Expected == string.Empty ? nameof(Expected) : Expected)}";
