...
public abstract class DynamicDataSource(ArgsCode argsCode)
{
    ...
    /// <summary>
    /// Represents a string needed in as part of the display name generated by the <see cref="GetDisplayName(MethodInfo, object?[])"/> method.
    /// </summary>
    internal const string testData_colon_whitespace = "testData: ";
    #endregion
    ...
    => $"{testMethod.Name}({testData_colon_whitespace}{args[0] as string})";
