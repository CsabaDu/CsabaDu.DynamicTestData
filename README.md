...
and an extendable abstract `DynamicDataSource` base class with fully implemented methods to create specific object arrays of the data stored in `TestData` records. You can use these methods out-of-box in enumeration members of its derived dynamic data source classes.
